...
-- 기존 50개 INSERT 블록을 통째로 교체
INSERT INTO port_current (port_code, updated_at, level, tpfs) VALUES
  ...
  ('CNDLC','2026-01-01 00:00:00+00','LOW',0),('HKHKG','2026-01-01 00:00:00+00','LOW',0),
  ('CNXMN','2026-01-01 00:00:00+00','LOW',0),('TWKHH','2026-01-01 00:00:00+00','LOW',0),
  ('VNTOT','2026-01-01 00:00:00+00','LOW',0),('VNHPH','2026-01-01 00:00:00+00','LOW',0),
  ('THLCH','2026-01-01 00:00:00+00','LOW',0),('SGSIN','2026-01-01 00:00:00+00','LOW',0),
  ('MYLPK','2026-01-01 00:00:00+00','LOW',0),('MYTPP','2026-01-01 00:00:00+00','LOW',0),
  ...
  ('AEJEA','2026-01-01 00:00:00+00','LOW',0),('INNSA','2026-01-01 00:00:00+00','LOW',0),
  ('INMUN','2026-01-01 00:00:00+00','LOW',0),('OMSLL','2026-01-01 00:00:00+00','LOW',0),
  ('SADMM','2026-01-01 00:00:00+00','LOW',0),('QAHMD','2026-01-01 00:00:00+00','LOW',0),
  ...
  ('USHOU','2026-01-01 00:00:00+00','LOW',0),('USORF','2026-01-01 00:00:00+00','LOW',0),
  ('USMSY','2026-01-01 00:00:00+00','LOW',0),('CAVAN','2026-01-01 00:00:00+00','LOW',0),
  ('MXZLO','2026-01-01 00:00:00+00','LOW',0),('BRSSZ','2026-01-01 00:00:00+00','LOW',0),
  ('COCTG','2026-01-01 00:00:00+00','LOW',0),('PECLL','2026-01-01 00:00:00+00','LOW',0),
  ('ECGYE','2026-01-01 00:00:00+00','LOW',0),('COBUN','2026-01-01 00:00:00+00','LOW',0),
  ('PABLB','2026-01-01 00:00:00+00','LOW',0),('PACLN','2026-01-01 00:00:00+00','LOW',0),
  ('RULED','2026-01-01 00:00:00+00','LOW',0),('RUVVO','2026-01-01 00:00:00+00','LOW',0),
  ('RUNVS','2026-01-01 00:00:00+00','LOW',0),('KZAKT','2026-01-01 00:00:00+00','LOW',0),
  ('MATNG','2026-01-01 00:00:00+00','LOW',0),('MACAS','2026-01-01 00:00:00+00','LOW',0),
  ('NGAPP','2026-01-01 00:00:00+00','LOW',0),('KEMBA','2026-01-01 00:00:00+00','LOW',0),
  ('ZADUR','2026-01-01 00:00:00+00','LOW',0),('TZDAR','2026-01-01 00:00:00+00','LOW',0),
  ('EGPSD','2026-01-01 00:00:00+00','LOW',0),('EGEDK','2026-01-01 00:00:00+00','LOW',0),
  ('DJJIB','2026-01-01 00:00:00+00','LOW',0)
